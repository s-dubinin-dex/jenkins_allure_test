...
public class MestoTest {
    String bearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NWRkYjhjMzZiNDA1OTAwM2Q5ZDliOTIiLCJpYXQiOjE3MTAxNTIwMTcsImV4cCI6MTcxMDc1NjgxN30.QbQ6r5GsNXcRCEwkdxWuSKF8NyfxqcKAvkFKFo6RslM";
    ...
    public void addNewPhoto() {
        given()
                ...
                .body("{\"name\":\"Москв\",\"link\":\"https://code.s3.yandex.net/qa-automation-engineer/java/files/paid-track/sprint1/photoSelenium.jpg\"}") // Формируем тело запроса
